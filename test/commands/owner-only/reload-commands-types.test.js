...
jest.mock('../../../src/commands', () => {
    ...
    map.set('reloadslashs', {
        ...
        run: async (int, language) => {
            const real = jest.requireActual('../../../src/commands/owner-only/reload-commands').default;
...
describe('/reloadslashs com todos os tipos de argumento', () => {
    it('constrói comandos globais com INTEGER/USER/ATTACHMENT/choices/autocomplete', async () => {
        ...
        const globalBody = mockRest.put.mock.calls[0][1];
        ...
        const ownerBody = mockRest.put.mock.calls[1][1];
