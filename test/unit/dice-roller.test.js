...
const {
    ...
    validateDiceString
} = require('../../src/resources/utils/dice-roller');
...
describe('formatDiceEmbedOutput', () => {
    ...
    it('com idioma usa chave localizada', () => {
        const embed = formatDiceEmbedOutput(diceRoller('2d1+3'), 'en-us').toJSON();
